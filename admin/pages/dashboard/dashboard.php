      ...
      <div class="mainCards">
        <div class="card pt-5 pb-5 pl-3 pr-3">
          <a href="?action=products" class="cardInner">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-11 h-11 card_icon">
          ...
          ?>
          <h4 style="color: white;"><?php echo $countP['count']?></h4>
        </div>
        <div class="card pt-5 pb-5 pl-3 pr-3">
          ...
          ?>
          <h4 style="color: white;"><?php echo $countO['count']?></h4>
        </div>
        <div class="card pt-5 pb-5 pl-3 pr-3">
          ...
          ?>
          <h4 style="color: white;"><?php echo $countC['count']?></h4>
        </div>
        <div class="card pt-5 pb-5 pl-3 pr-3">
          <div class="cardInner">
