...
<body>
    ...
    if ($number < 0) {
        return $negative . docSoThanhChu(abs($number));
    }
    ...
    switch (true) {
        ...
        case $number < 100:
            ...
            if ($units) {
                $string .= $hyphen . ($units == 1 ? 'mốt' : $dictionary[$units]);
            }
            break;
        case $number < 1000:
            $hundreds = $number / 100;
            ...
            if ($remainder) {
                $string .= $conjunction . ($remainder < 10 ? 'lẻ ' : '') . docSoThanhChu($remainder);
            }
            break;
        default:
            ...
            $string = docSoThanhChu($numBaseUnits) . ' ';
            ...
            if ($remainder) {
                ...
                $string .= docSoThanhChu($remainder);
            }
            break;
    }
